  ...
  return (
    <div className='container-fluid' style={{ height: '100vh' }}>
      <div className='row flex-nowrap' style={{ height: '100%' }}>
        <div className='col-auto col-md-2 col-xl-2 px-sm-2 px-0 sidebarcolor' style={{ minHeight: '100vh' }}>
          <div className='d-flex flex-column align-items-center align-items-sm-start px-3 pt-2'>
            <Link to="/dash" className='d-flex align-items-center pb-3 mb-md-1 mt-md-3 me-md-auto text-white'>
              <span className='fs-5 fw-bolder d-none d-sm-inline'>ONLINE REQUEST</span>
            </Link>
            <ul className='nav nav-pills flex-column mb-sm-auto mb-0 align-items-center' id='menu'>
              ...
              <li className='w-100'>
                <Link to="/userdash/apply" className='nav-link text-white px-0 align-middle'> 
                  ...
                  <span className='ms-2 d-none d-sm-inline'> APPLY REQUESTS</span>
                </Link>
              </li>
              <li className='w-100'>
                <Link to="/userdash/home" className='nav-link text-white px-0 align-middle'> 
                  <i className="bi bi-house"></i>
                  <span className='ms-2 d-none d-sm-inline'> REQUEST STATUS</span>
                </Link>
              </li>
              <li>
                <Link to="/" className='nav-link px-0 align-middle text-white'>
